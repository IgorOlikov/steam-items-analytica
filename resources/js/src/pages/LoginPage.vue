<template>
    <div class="min-h-screen flex items-center justify-center w-full dark:bg-gray-200">
        <div class="bg-white dark:bg-green-300 shadow-md rounded-lg px-8 py-6 max-w-md">
            ...
            <form action="#">
                <div class="mb-4">
                    <label for="email" class="block text-sm font-medium  text-black mb-2">Email Адрес</label>
                    <input
                        v-model="email"
                        type="email"
                        id="email"
                ...
                <div class="mb-4">
                    <label for="password" class="block text-sm font-medium text-black mb-2">Пароль</label>
                    <input
                        v-model="password"
                        type="password"
                        id="password"
                ...
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center">
                        ...
                        <label for="remember" class="ml-2 block text-sm text-black">Запомнить меня</label>
                    </div>
                    <a href="/register"
                ...
                <button
                    ...
                    type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Login</button>
            </form>
        </div>
    </div>
</template>
